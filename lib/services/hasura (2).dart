...
class Hasura {
  ...
  static Future<void> init() async {
    ...
    _hasuraConnect = HasuraConnect(url, headers: {"x-hasura-admin-secret": ""});
  }
...
mutation MyMutation {
  ...
  static Future<dynamic> insertManager(
    ...
    String query = """
mutation MyMutation {
  insert_managers_one(object: {email: "$email", password: "$password", otdel: {data: {name: "$otdel"}}, Name: "$name", FullName: "$fullname", Family: "$family"}) {
    id
  }
}
      """;
